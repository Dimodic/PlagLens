...
- Name: specs\courses\course-archive-restore.spec.ts >> Course archive / restore >> archived course shows up in the «В архиве» filter on /courses
- Location: e2e\specs\courses\course-archive-restore.spec.ts:50:3

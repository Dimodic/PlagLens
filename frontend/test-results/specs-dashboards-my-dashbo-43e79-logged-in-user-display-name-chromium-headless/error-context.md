...
- Name: specs\dashboards\my-dashboard.spec.ts >> My Dashboard /me >> greeting includes the logged-in user display name
- Location: e2e\specs\dashboards\my-dashboard.spec.ts:24:3
...
Locator: getByRole('heading', { name: /Здравствуйте/ })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Здравствуйте/ })

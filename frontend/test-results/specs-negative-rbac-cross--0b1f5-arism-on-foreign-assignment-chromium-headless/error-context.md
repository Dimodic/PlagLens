...
- Name: specs\negative\rbac-cross-course.spec.ts >> Cross-course / cross-tenant teacher isolation >> teacher cannot start plagiarism on foreign assignment
- Location: e2e\specs\negative\rbac-cross-course.spec.ts:39:3

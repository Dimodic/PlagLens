...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Activity tab shows feed or empty state
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:113:3

...
- Name: specs\courses\course-duplicate.spec.ts >> Course duplicate >> duplicate API call hits POST /courses/:id:duplicate
- Location: e2e\specs\courses\course-duplicate.spec.ts:31:3

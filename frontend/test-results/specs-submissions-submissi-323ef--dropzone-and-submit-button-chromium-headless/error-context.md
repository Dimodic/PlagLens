...
- Name: specs\submissions\submission-upload.spec.ts >> Submission upload >> upload page renders dropzone and submit button
- Location: e2e\specs\submissions\submission-upload.spec.ts:27:3

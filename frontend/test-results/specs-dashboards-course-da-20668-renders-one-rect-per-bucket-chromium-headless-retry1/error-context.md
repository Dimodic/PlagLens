...
- Name: specs\dashboards\course-dashboard-charts-svg.spec.ts >> Course Dashboard charts (mocked) >> Grades histogram renders one <rect> per bucket
- Location: e2e\specs\dashboards\course-dashboard-charts-svg.spec.ts:71:3

...
- Name: specs\dashboards\course-dashboard-charts-svg.spec.ts >> Course Dashboard charts (mocked) >> Timeline chart renders an SVG container for line data
- Location: e2e\specs\dashboards\course-dashboard-charts-svg.spec.ts:90:3

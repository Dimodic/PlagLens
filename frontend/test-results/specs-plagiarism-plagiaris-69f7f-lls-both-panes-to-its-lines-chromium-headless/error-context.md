...
- Name: specs\plagiarism\plagiarism-pair-diff.spec.ts >> Plagiarism / pair diff >> clicking fragment scrolls both panes to its lines
- Location: e2e\specs\plagiarism\plagiarism-pair-diff.spec.ts:101:3

...
- Name: specs\plagiarism\plagiarism-runs-list.spec.ts >> Plagiarism / runs list >> Auto-refresh switch is rendered (disabled per current behaviour)
- Location: e2e\specs\plagiarism\plagiarism-runs-list.spec.ts:99:3

...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Overview tab renders all KPI cards
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:16:3

...
- Name: specs\profile\profile-security-oauth.spec.ts >> Profile security — OAuth identities >> teacher opens OAuth tab and sees four provider rows
- Location: e2e\specs\profile\profile-security-oauth.spec.ts:11:3

...
- Name: specs\courses\course-create.spec.ts >> /courses/new — create >> duplicate slug → server returns 409 (problem alert displayed)
- Location: e2e\specs\courses\course-create.spec.ts:54:3

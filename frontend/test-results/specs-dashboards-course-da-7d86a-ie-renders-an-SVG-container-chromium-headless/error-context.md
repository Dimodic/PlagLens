...
- Name: specs\dashboards\course-dashboard-charts-svg.spec.ts >> Course Dashboard charts (mocked) >> Language pie renders an SVG container
- Location: e2e\specs\dashboards\course-dashboard-charts-svg.spec.ts:111:3

...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> all 8 dashboard tabs are visible
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:27:3

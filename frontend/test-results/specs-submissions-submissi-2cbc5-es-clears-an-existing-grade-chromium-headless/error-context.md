...
- Name: specs\submissions\submission-grading.spec.ts >> Submission grading (teacher) >> teacher deletes (clears) an existing grade
- Location: e2e\specs\submissions\submission-grading.spec.ts:64:3

...
- Name: specs\plagiarism\plagiarism-pair-diff.spec.ts >> Plagiarism / pair diff >> renders side-by-side panes with author labels
- Location: e2e\specs\plagiarism\plagiarism-pair-diff.spec.ts:58:3

...
- Name: specs\courses\course-duplicate.spec.ts >> Course duplicate >> teacher opens menu and clicks Дублировать (no UI crash)
- Location: e2e\specs\courses\course-duplicate.spec.ts:14:3

...
- Name: specs\courses\course-groups.spec.ts >> /courses/:slug/groups >> empty group name fails client-side validation
- Location: e2e\specs\courses\course-groups.spec.ts:49:3

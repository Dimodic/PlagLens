...
- Name: specs\reporting\google-sheets-link.spec.ts >> Google Sheets link >> invalid JSON in mapping shows error toast and does not save
- Location: e2e\specs\reporting\google-sheets-link.spec.ts:65:3

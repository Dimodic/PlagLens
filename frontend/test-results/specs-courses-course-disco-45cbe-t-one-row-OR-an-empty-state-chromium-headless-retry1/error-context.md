...
- Name: specs\courses\course-discovery.spec.ts >> Course discovery >> teacher sees at least one row OR an empty state
- Location: e2e\specs\courses\course-discovery.spec.ts:12:3

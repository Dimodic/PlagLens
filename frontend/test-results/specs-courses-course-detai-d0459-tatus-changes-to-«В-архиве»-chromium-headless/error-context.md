...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> archive flow — open menu, confirm dialog, status changes to «В архиве»
- Location: e2e\specs\courses\course-detail.spec.ts:120:3

...
- Name: specs\courses\course-join.spec.ts >> /courses/join — invitation flow >> invalid code yields a problem alert (or 404 from backend)
- Location: e2e\specs\courses\course-join.spec.ts:36:3

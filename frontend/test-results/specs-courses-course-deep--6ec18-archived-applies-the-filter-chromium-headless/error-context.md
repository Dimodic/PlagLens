...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of /courses?status=archived applies the filter
- Location: e2e\specs\courses\course-deep-links.spec.ts:122:3

...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Grades tab renders per-assignment averages section
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:60:3

...
- Name: specs\courses\course-invitations.spec.ts >> /courses/:slug/invitations >> opening Create dialog reveals the form fields
- Location: e2e\specs\courses\course-invitations.spec.ts:25:3

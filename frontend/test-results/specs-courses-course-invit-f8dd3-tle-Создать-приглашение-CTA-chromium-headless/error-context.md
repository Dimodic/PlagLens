...
- Name: specs\courses\course-invitations.spec.ts >> /courses/:slug/invitations >> teacher sees title + Создать приглашение CTA
- Location: e2e\specs\courses\course-invitations.spec.ts:13:3

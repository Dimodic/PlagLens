...
- Name: specs\courses\courses-list.spec.ts >> /courses — list >> status filter "В архиве" shows archived courses only
- Location: e2e\specs\courses\courses-list.spec.ts:63:3

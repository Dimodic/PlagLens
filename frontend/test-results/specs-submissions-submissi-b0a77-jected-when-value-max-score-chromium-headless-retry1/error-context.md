...
- Name: specs\submissions\submission-grading.spec.ts >> Submission grading (teacher) >> grade input is rejected when value > max_score
- Location: e2e\specs\submissions\submission-grading.spec.ts:23:3

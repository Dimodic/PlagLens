...
- Name: specs\courses\courses-list.spec.ts >> /courses — list >> teacher sees the «Создать курс» CTA and the list title
- Location: e2e\specs\courses\courses-list.spec.ts:15:3

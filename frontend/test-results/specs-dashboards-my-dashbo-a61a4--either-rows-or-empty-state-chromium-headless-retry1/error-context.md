...
- Name: specs\dashboards\my-dashboard.spec.ts >> My Dashboard /me >> "Мои курсы" section has either rows or empty state
- Location: e2e\specs\dashboards\my-dashboard.spec.ts:42:3

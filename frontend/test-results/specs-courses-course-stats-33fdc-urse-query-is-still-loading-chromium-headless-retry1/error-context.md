...
- Name: specs\courses\course-stats-tab.spec.ts >> /courses/:slug/stats — stats tab >> stats title falls back gracefully when course query is still loading
- Location: e2e\specs\courses\course-stats-tab.spec.ts:100:3

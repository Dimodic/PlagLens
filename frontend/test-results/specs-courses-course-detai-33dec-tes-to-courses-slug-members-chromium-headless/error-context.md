...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> clicking Members tab navigates to /courses/:slug/members
- Location: e2e\specs\courses\course-detail.spec.ts:57:3

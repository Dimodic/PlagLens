...
- Name: specs\profile\profile-security-password.spec.ts >> Profile security — password change >> teacher opens password tab and sees three password inputs
- Location: e2e\specs\profile\profile-security-password.spec.ts:9:3

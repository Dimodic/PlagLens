...
- Name: specs\courses\course-join.spec.ts >> /courses/join — invitation flow >> short code (<4 chars) is rejected client-side
- Location: e2e\specs\courses\course-join.spec.ts:27:3

...
- Name: specs\notifications\notification-bell-dropdown.spec.ts >> Notification bell dropdown >> "Открыть все" link navigates to /notifications
- Location: e2e\specs\notifications\notification-bell-dropdown.spec.ts:27:3
...
Call log:
  - waiting for getByTestId('bell-icon')

...
- Name: specs\profile\profile-security-oauth.spec.ts >> Profile security — OAuth identities >> clicking Link Google redirects to OAuth start URL (mocked)
- Location: e2e\specs\profile\profile-security-oauth.spec.ts:22:3

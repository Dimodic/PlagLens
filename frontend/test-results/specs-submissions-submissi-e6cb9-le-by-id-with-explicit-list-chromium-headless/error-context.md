...
- Name: specs\submissions\submission-bulk.spec.ts >> Submission bulk operations >> batch select rule "by_id" with explicit list
- Location: e2e\specs\submissions\submission-bulk.spec.ts:89:3

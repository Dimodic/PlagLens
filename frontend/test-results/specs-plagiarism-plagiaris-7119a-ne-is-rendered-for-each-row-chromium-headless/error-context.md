...
- Name: specs\plagiarism\plagiarism-runs-list.spec.ts >> Plagiarism / runs list >> similarity bar zone is rendered for each row
- Location: e2e\specs\plagiarism\plagiarism-runs-list.spec.ts:82:3

...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> teacher sees the Создать задание button
- Location: e2e\specs\courses\course-detail.spec.ts:46:3

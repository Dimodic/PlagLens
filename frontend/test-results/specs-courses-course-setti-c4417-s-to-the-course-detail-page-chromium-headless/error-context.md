...
- Name: specs\courses\course-settings.spec.ts >> /courses/:slug/settings >> Cancel returns to the course detail page
- Location: e2e\specs\courses\course-settings.spec.ts:40:3

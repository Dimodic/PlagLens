...
- Name: specs\courses\courses-list.spec.ts >> /courses — list >> clicking a course card navigates to /courses/:slug
- Location: e2e\specs\courses\courses-list.spec.ts:79:3

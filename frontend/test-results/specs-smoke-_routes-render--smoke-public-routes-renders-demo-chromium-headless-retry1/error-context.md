...
- Name: specs\smoke\_routes-render.spec.ts >> @smoke public routes >> renders /demo
- Location: e2e\specs\smoke\_routes-render.spec.ts:80:5

# Error details

```
Error: Console errors on /demo:
...
- generic [ref=e4]:
  - generic [ref=e5]:
    ...
    - generic [ref=e12]:
      ...
      - generic [ref=e14]: RU
  - generic [ref=e15]:
    - generic [ref=e16]: Демо-режим
    - generic [ref=e17]: Один клик — мгновенный вход под выбранной ролью.
    - generic [ref=e18]: Эти учётные записи существуют только в seed-данных и не должны быть включены в продакшене.
    - generic [ref=e19]:
      - generic [ref=e20]:
        - generic [ref=e21]: АД
        - generic [ref=e22]:
          ...
          - generic [ref=e25]: admin@demo.local — Полный доступ внутри тенанта
      ...
      - generic [ref=e27]:
        ...
        - generic [ref=e29]:
          ...
          - generic [ref=e32]: teacher@demo.local — Создаёт курсы и управляет ими
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e36]:
          - generic [ref=e37]:
            - text: Ассистент
            - generic [ref=e38]: assistant
          - generic [ref=e39]: assistant@demo.local — Проверяет посылки в курсах
      ...
      - generic [ref=e41]:
        ...
        - generic [ref=e43]:
          - generic [ref=e44]:
            - text: Студент 1
            - generic [ref=e45]: student
          - generic [ref=e46]: student1@demo.local — Отправляет решения
      ...
      - generic [ref=e48]:
        ...
        - generic [ref=e50]:
          ...
          - generic [ref=e53]: student2@demo.local — Отправляет решения
      ...
      - generic [ref=e55]:
        ...
        - generic [ref=e57]:
          ...
          - generic [ref=e60]: student3@demo.local — Отправляет решения
      ...
      - generic [ref=e62]:
        ...
        - generic [ref=e64]:
          - generic [ref=e65]:
            - text: Студент 4
            - generic [ref=e66]: student
          - generic [ref=e67]: student4@demo.local — Отправляет решения
        - button "Войти" [ref=e68] [cursor=pointer]
  - link "К обычному входу" [ref=e70] [cursor=pointer]:
    - /url: /login
```

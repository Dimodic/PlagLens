...
- Name: specs\plagiarism\plagiarism-run-detail.spec.ts >> Plagiarism / run detail >> cross-only switch in Pairs tab can be toggled
- Location: e2e\specs\plagiarism\plagiarism-run-detail.spec.ts:118:3

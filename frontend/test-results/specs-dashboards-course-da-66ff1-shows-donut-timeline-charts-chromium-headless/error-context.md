...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> AI tab shows donut + timeline charts
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:79:3

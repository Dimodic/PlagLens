...
- Name: specs\submissions\submission-self-service.spec.ts >> Submission self-service >> language filter narrows the list
- Location: e2e\specs\submissions\submission-self-service.spec.ts:43:3

...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> teacher sees title, status badge, slug, settings button
- Location: e2e\specs\courses\course-detail.spec.ts:15:3

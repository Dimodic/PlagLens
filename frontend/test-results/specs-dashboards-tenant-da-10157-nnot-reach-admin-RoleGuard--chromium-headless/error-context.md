...
- Name: specs\dashboards\tenant-dashboard.spec.ts >> Tenant Dashboard /admin >> teachers cannot reach /admin (RoleGuard)
- Location: e2e\specs\dashboards\tenant-dashboard.spec.ts:35:3

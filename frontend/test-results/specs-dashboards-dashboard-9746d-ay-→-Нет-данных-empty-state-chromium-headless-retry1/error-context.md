...
- Name: specs\dashboards\dashboards-empty-states.spec.ts >> Dashboards empty states (mocked) >> Timeline returns empty array → "Нет данных" empty state
- Location: e2e\specs\dashboards\dashboards-empty-states.spec.ts:38:3

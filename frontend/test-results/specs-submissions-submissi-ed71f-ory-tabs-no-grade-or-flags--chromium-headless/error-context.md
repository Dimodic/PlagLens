...
- Name: specs\submissions\submission-detail.spec.ts >> Submission detail >> student sees only files / feedback / plagiarism / ai / history tabs (no grade or flags)
- Location: e2e\specs\submissions\submission-detail.spec.ts:23:3

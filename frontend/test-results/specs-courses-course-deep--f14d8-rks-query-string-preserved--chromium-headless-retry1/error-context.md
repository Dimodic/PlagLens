...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of /courses/:slug/members?role=assistant works (query string preserved)
- Location: e2e\specs\courses\course-deep-links.spec.ts:91:3

...
- Name: specs\submissions\submission-self-service.spec.ts >> Submission self-service >> API /users/me/assignments/:id/submissions returns only own submissions
- Location: e2e\specs\submissions\submission-self-service.spec.ts:69:3

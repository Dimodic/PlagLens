...
- Name: specs\negative\rbac-cross-course.spec.ts >> Cross-course / cross-tenant teacher isolation >> teacher cannot DELETE a course they do not own
- Location: e2e\specs\negative\rbac-cross-course.spec.ts:25:3

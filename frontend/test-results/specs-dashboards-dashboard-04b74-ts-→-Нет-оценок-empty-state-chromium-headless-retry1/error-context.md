...
- Name: specs\dashboards\dashboards-empty-states.spec.ts >> Dashboards empty states (mocked) >> Grades distribution returns empty buckets → "Нет оценок" empty state
- Location: e2e\specs\dashboards\dashboards-empty-states.spec.ts:13:3

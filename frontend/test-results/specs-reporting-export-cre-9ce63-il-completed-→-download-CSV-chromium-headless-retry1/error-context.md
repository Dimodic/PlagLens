...
- Name: specs\reporting\export-create-csv.spec.ts >> Create CSV export (course) >> API path: create export → poll until completed → download CSV
- Location: e2e\specs\reporting\export-create-csv.spec.ts:53:3

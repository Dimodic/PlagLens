...
- Name: specs\notifications\notification-bell-dropdown.spec.ts >> Notification bell dropdown >> bell icon is visible after login
- Location: e2e\specs\notifications\notification-bell-dropdown.spec.ts:11:3
...
Locator: getByTestId('notif-bell')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('notif-bell')

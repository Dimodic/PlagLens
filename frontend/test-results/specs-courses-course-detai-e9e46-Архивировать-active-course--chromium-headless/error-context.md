...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> opening menu shows Дублировать and Архивировать (active course)
- Location: e2e\specs\courses\course-detail.spec.ts:105:3

...
- Name: specs\profile\profile-security-sessions.spec.ts >> Profile security — sessions >> non-current sessions show a "Завершить" button
- Location: e2e\specs\profile\profile-security-sessions.spec.ts:40:3

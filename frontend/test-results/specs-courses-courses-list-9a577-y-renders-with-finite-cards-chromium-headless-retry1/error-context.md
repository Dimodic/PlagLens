...
- Name: specs\courses\courses-list.spec.ts >> /courses — list >> cursor pagination — list initially renders with finite cards
- Location: e2e\specs\courses\courses-list.spec.ts:105:3

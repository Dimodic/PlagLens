...
```
Error: Login failed (401): {"type":"https://docs.plaglens.ru/errors/two_factor_required","title":"2FA required","status":401,"detail":"Provide TOTP code to complete login.","instance":"/api/v1/auth/login","code":"TWO_FACTOR_REQUIRED","request_id":"4004792f308344fca9694d6ce2099cd2"}
```

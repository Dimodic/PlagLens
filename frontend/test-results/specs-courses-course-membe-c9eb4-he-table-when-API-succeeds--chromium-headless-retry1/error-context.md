...
- Name: specs\courses\course-members.spec.ts >> /courses/:slug/members >> add-member by user_id places a row into the table (when API succeeds)
- Location: e2e\specs\courses\course-members.spec.ts:85:3

...
- Name: specs\courses\course-settings.spec.ts >> /courses/:slug/settings >> CORS origins input accepts multiline input
- Location: e2e\specs\courses\course-settings.spec.ts:54:3

...
- Name: specs\negative\rbac-cross-course.spec.ts >> Cross-course / cross-tenant teacher isolation >> teacher cannot grade a foreign submission
- Location: e2e\specs\negative\rbac-cross-course.spec.ts:46:3

...
- Name: specs\courses\course-invitations.spec.ts >> /courses/:slug/invitations >> clicking the copy button does not throw (clipboard tooltip changes to «Скопировано»)
- Location: e2e\specs\courses\course-invitations.spec.ts:66:3

...
- Name: specs\profile\profile-api-keys.spec.ts >> Profile API keys >> create modal flow: name + scopes -> success warning + once-shown key
- Location: e2e\specs\profile\profile-api-keys.spec.ts:15:3

...
- Name: specs\courses\course-invitations.spec.ts >> /courses/:slug/invitations >> revoking an invitation removes its row
- Location: e2e\specs\courses\course-invitations.spec.ts:90:3

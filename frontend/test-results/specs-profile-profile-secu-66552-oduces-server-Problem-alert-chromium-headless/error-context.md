...
- Name: specs\profile\profile-security-password.spec.ts >> Profile security — password change >> wrong current_password produces server Problem alert
- Location: e2e\specs\profile\profile-security-password.spec.ts:29:3

...
- Name: specs\negative\rbac-cross-course.spec.ts >> Cross-course / cross-tenant teacher isolation >> teacher cannot read submissions of a course they are not in
- Location: e2e\specs\negative\rbac-cross-course.spec.ts:32:3

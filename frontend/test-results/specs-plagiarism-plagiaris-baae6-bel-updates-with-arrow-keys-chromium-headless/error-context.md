...
- Name: specs\plagiarism\plagiarism-run-detail.spec.ts >> Plagiarism / run detail >> similarity slider value label updates with arrow keys
- Location: e2e\specs\plagiarism\plagiarism-run-detail.spec.ts:138:3

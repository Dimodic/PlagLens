...
- Name: specs\submissions\submission-versioning.spec.ts >> Submission versioning >> selection strategy "last" auto-selects newest version (best-effort API)
- Location: e2e\specs\submissions\submission-versioning.spec.ts:105:3

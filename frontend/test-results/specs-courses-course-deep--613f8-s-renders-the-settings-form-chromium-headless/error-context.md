...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of /courses/:slug/settings renders the settings form
- Location: e2e\specs\courses\course-deep-links.spec.ts:61:3

...
- Name: specs\submissions\submission-grading.spec.ts >> Submission grading (teacher) >> after grade is set, "Снять оценку" button appears
- Location: e2e\specs\submissions\submission-grading.spec.ts:52:3

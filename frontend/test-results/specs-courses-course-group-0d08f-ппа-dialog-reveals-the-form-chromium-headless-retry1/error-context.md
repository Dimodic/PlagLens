...
- Name: specs\courses\course-groups.spec.ts >> /courses/:slug/groups >> opening Новая группа dialog reveals the form
- Location: e2e\specs\courses\course-groups.spec.ts:21:3

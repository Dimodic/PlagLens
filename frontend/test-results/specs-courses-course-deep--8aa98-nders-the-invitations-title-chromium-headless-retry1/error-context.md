...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of /courses/:slug/invitations renders the invitations title
- Location: e2e\specs\courses\course-deep-links.spec.ts:46:3

...
- Name: specs\submissions\submission-flags.spec.ts >> Submission flags >> manual flag appears in the flags list with kind=manual badge
- Location: e2e\specs\submissions\submission-flags.spec.ts:32:3

...
- Name: specs\plagiarism\plagiarism-runs-list.spec.ts >> Plagiarism / runs list >> row has open link to /plagiarism-runs/:id
- Location: e2e\specs\plagiarism\plagiarism-runs-list.spec.ts:67:3

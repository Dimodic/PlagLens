...
- Name: specs\reporting\google-sheets-link.spec.ts >> Google Sheets link >> save flow accepts a spreadsheet id + columns mapping JSON
- Location: e2e\specs\reporting\google-sheets-link.spec.ts:35:3

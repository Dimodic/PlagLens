...
- Name: specs\courses\course-groups.spec.ts >> /courses/:slug/groups >> creating a group with capacity submits and closes dialog (when API is healthy)
- Location: e2e\specs\courses\course-groups.spec.ts:34:3

...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Grades tab shows histogram BarChart
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:46:3

...
- Name: specs\reporting\export-create-csv.spec.ts >> Create CSV export (course) >> UI: open modal and submit assignment_grades + CSV
- Location: e2e\specs\reporting\export-create-csv.spec.ts:32:3

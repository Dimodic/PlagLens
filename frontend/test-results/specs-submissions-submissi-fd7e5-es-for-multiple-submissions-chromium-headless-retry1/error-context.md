...
- Name: specs\submissions\submission-bulk.spec.ts >> Submission bulk operations >> batch grade update endpoint accepts grades for multiple submissions
- Location: e2e\specs\submissions\submission-bulk.spec.ts:17:3

...
- Name: specs\courses\course-create.spec.ts >> /courses/new — create >> empty name fails client-side validation
- Location: e2e\specs\courses\course-create.spec.ts:36:3

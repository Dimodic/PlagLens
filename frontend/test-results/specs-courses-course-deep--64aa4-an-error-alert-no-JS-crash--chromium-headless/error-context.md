...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of an unknown slug shows an error alert (no JS crash)
- Location: e2e\specs\courses\course-deep-links.spec.ts:132:3

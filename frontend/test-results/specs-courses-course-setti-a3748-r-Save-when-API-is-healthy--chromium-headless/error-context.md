...
- Name: specs\courses\course-settings.spec.ts >> /courses/:slug/settings >> renaming the course persists after Save (when API is healthy)
- Location: e2e\specs\courses\course-settings.spec.ts:21:3

...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> "Экспорты" link in header is clickable and goes to course exports
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:133:3

...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> clicking Groups tab navigates to /courses/:slug/groups
- Location: e2e\specs\courses\course-detail.spec.ts:73:3

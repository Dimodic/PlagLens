...
- Name: specs\courses\course-detail.spec.ts >> /courses/:slug — detail >> clicking Invitations tab navigates to /courses/:slug/invitations
- Location: e2e\specs\courses\course-detail.spec.ts:89:3

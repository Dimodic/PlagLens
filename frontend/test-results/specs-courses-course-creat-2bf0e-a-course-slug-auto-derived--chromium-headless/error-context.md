...
- Name: specs\courses\course-create.spec.ts >> /courses/new — create >> teacher can create a course (slug auto-derived)
- Location: e2e\specs\courses\course-create.spec.ts:16:3

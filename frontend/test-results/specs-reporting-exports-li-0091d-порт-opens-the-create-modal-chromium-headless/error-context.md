...
- Name: specs\reporting\exports-list.spec.ts >> Exports list >> clicking "Новый экспорт" opens the create modal
- Location: e2e\specs\reporting\exports-list.spec.ts:26:3

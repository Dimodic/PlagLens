...
- Name: specs\courses\course-stats-tab.spec.ts >> /courses/:slug/stats — stats tab >> clicking the «Статистика» tab navigates to /courses/:slug/stats
- Location: e2e\specs\courses\course-stats-tab.spec.ts:46:3

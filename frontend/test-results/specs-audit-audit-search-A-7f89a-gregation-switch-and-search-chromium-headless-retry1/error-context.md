...
Call log:
  - waiting for getByTestId('audit-search-agg-toggle')
    - locator resolved to <input checked role="switch" type="checkbox" data-checked="true" id="mantine-4xygt8bre" data-testid="audit-search-agg-toggle" class="m_926b4011 mantine-Switch-input"/>

...
- Name: specs\profile\profile-security-sessions.spec.ts >> Profile security — sessions >> teacher opens Sessions tab and sees at least one session row
- Location: e2e\specs\profile\profile-security-sessions.spec.ts:8:3

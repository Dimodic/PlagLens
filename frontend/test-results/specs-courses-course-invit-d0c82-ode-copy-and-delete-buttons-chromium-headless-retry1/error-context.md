...
- Name: specs\courses\course-invitations.spec.ts >> /courses/:slug/invitations >> pre-seeded invitation row is visible with code, copy, and delete buttons
- Location: e2e\specs\courses\course-invitations.spec.ts:38:3

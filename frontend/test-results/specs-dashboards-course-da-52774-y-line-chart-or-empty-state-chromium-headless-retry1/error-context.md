...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Timeline tab shows weekly line chart or empty state
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:89:3

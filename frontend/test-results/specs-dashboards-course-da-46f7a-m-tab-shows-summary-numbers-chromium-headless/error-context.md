...
- Name: specs\dashboards\course-dashboard.spec.ts >> Course Dashboard >> Plagiarism tab shows summary numbers
- Location: e2e\specs\dashboards\course-dashboard.spec.ts:70:3

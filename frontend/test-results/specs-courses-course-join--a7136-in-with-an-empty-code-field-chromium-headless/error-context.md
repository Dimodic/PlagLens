...
- Name: specs\courses\course-join.spec.ts >> /courses/join — invitation flow >> student lands on /courses/join with an empty code field
- Location: e2e\specs\courses\course-join.spec.ts:11:3

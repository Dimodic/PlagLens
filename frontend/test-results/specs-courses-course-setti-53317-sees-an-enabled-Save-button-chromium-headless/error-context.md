...
- Name: specs\courses\course-settings.spec.ts >> /courses/:slug/settings >> teacher (owner) sees an enabled Save button
- Location: e2e\specs\courses\course-settings.spec.ts:9:3

...
- Name: specs\profile\profile-security-sessions.spec.ts >> Profile security — sessions >> current session is marked with "текущая" badge
- Location: e2e\specs\profile\profile-security-sessions.spec.ts:21:3

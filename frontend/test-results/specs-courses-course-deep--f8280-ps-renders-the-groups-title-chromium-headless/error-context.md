...
- Name: specs\courses\course-deep-links.spec.ts >> Courses — deep links / direct URL navigation >> cold load of /courses/:slug/groups renders the groups title
- Location: e2e\specs\courses\course-deep-links.spec.ts:31:3

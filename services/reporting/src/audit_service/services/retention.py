...
async def _resource_ids_in_partition(
    ...
    if session.bind is not None and session.bind.dialect.name == "postgresql":
        # SCHEMA is a module constant and partition_name is generated by us
        # (date-based), never user-supplied — interpolation is safe here.
        sql = text(
            f'SELECT DISTINCT resource_id FROM "{SCHEMA}"."{partition_name}" '  # noqa: S608
